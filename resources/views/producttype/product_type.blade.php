								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="{{route('productdetail', $sp->id)}}">Chi tiết<i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="single-item">
			                            ...
			                            @endif
										<div class="single-item-header">
											<a href="{{route('productdetail', $sp_k->id)}}"><img src="source/image/product/{{$sp_k->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="{{route('productdetail', $sp_k->id)}}">Chi tiết<i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>

                    ...
                    <div class="beta-products-list">
                        ...
                        @foreach($sale_product as $sale)
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="{{route('productdetail', $sale->id)}}"><img src="source/image/product/{{$sale->image}}" alt="" height="250px"></a>
                                    </div>
                                    <div class="single-item-body">
                                    ...
                                    <div class="single-item-caption">
                                        ...
                                        <a class="beta-btn primary" href="{{route('productdetail', $sale->id)}}">Chi tiết<i class="fa fa-chevron-right"></i></a>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            </div>

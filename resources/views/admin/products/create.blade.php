...
<div class="m-portlet m-portlet--tab" >
    ...
    <!--begin::Form-->
    <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ action('Admin\ProductController@store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group row">
                ...
                <div class="custom-file col-lg-6 col-md-9 col-sm-12">
                    <input type="file" class="form-control m-input custom-file-input" id="example-tel-input" name="image">
            ...
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-6">
                    <input class="form-control m-input" type="checkbox" value="1" name="new" id="example-datetime-local-input" checked="">
                </div>
            </div>      
        </div>
        <div class="m-portlet__foot m-portlet__foot--fit">
            <div class="m-form__actions">
                <div class="row">
                    ...
                    <div class="col-9">
                        <button type="submit" class="btn btn-success">{{ trans('master.submit') }}</button>
